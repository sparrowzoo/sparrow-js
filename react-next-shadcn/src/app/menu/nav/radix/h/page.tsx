    ...
    <div>
      ...
      >
        <NavigationMenu.List className="center shadow-blackA4 m-0 flex gap-[10px] rounded-[6px] text-white bg-block p-1 shadow-[0_2px_10px]">
          <NavigationMenu.Item>
            <NavigationMenu.Trigger className="text-violet11 bg-block hover:bg-violet3 focus:shadow-violet7 group flex select-none items-center justify-between gap-[2px] rounded-[4px] px-3 py-2 text-[15px] font-medium leading-none outline-hidden focus:shadow-[0_0_0_2px]">
              Learn{" "}
              <ChevronDownIcon
