    ...
    return (
        <div>
            ...
            <NavigationMenu.Root orientation="vertical"
                                 className="relative z-[1] bg-black flex flex-col w-[200px] justify-center">
                <NavigationMenu.List
                    className="center shadow-blackA4 m-0 flex flex-col gap-[10px] rounded-[6px] text-white bg-block p-1 shadow-[0_2px_10px]">
                    <NavigationMenu.Item>
                ...
                <div className="absolute z-[20] top-0 left-full flex w-full justify-center">
