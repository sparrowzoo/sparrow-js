...
<div id="divVerticalMenu">
    ...
    <div class="pure-menu">
        ...
        <ul class="pure-menu-list">
            ...
            <li class="pure-menu-item"><a href="${root_path}/examples/sparrow/domReady" class="pure-menu-link">Dom Ready
                测试</a>
            </li>
            <li class="pure-menu-item"><a href="${root_path}/examples/selector/selector"
                                          class="pure-menu-link">选择器</a>
            </li>
    ...
    <div class="pure-menu">
        ...
        <ul class="pure-menu-list">
            ...
            <li class="pure-menu-item"><a href="${root_path}/tools/qr-code" class="pure-menu-link">二维码在线生成器</a>
            </li>
    ...
    <div class="pure-menu">
        ...
        <ul class="pure-menu-list">
            ...
            <li class="pure-menu-item"><a target="_blank" href="${root_path}/fly"
                                          class="pure-menu-link">重定向flash缓存</a>
            </li>
