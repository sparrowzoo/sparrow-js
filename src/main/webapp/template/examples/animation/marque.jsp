...
<div id="layout">
   ...
   $("#d").marque(0, 2, 50);
            ...
            <div class="container">
                <!-- 必须加style否则获取不到style.left -->
                <div id="d" style="width: 800px; left: 0; top: 0;">
                    麻雀虽小，但五脏俱全
                    sparrow 源自中国俗语 麻雀虽小，但五脏俱全，全力打造一个全新的低耦合，0依赖的高性能java 开发基础框架。
                    这个框架我从11年开始写，中间重构了n遍，最原始的代码可能都找不到了，之所以坚持写，最初并不是想造新轮子。 主要是从中学习基础原理。
                    经过近十年的打磨，发现有些设计思想和理念，是值得学习的。比如spring mvc 的设计模式，orm ico 等等。
                    ...
                    使我们的业务依赖很多jar，而大部分的jar包可能是不需要的，代码变得臃肿，维护困难。 为此基于oop的基本思想，构建一层api,最大化的解耦。
                    <br/>
                    框架特点
                    相信程序员
                    ...
                    架构详细介绍 https://www.jianshu.com/p/74122495a463
                    <br/>
                    start
                    下载项目管理壳子sparrow-shell，通过该项目可以下载sparrow所以子项目 GIT 地址: git@github.com:sparrowzoo/sparrow-shell.git
                    具体操作见该项目 readme.md
                    <br/>
                    style 目录为codestyle 和checkstyle 及copyright 相关配置文件，朋友们可自行配置.
                    <br/>
                    编译sparrow-super 项目 该项目包括sparrow 所有依赖的jar,共用配置文件及sparrow 子项子的全局版本号,目前所有还没有上传至maven
                    仓库，感兴趣的朋友可以fork版本自行控制，待代码稳定后逐步上传至maven仓库共享。 maven编译命令
                    <br/>
                    ...
                    <br/>
                    测试用例 https://github.com/sparrowzoo/sparrow-test case 逐步完善中...
                    <br/>
