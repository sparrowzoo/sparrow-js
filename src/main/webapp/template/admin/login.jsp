            ...
            <fieldset>
                ...
                <div class="pure-control-group">
                    ...
                    <img id="imgLoginValidateCode"
                         onclick="$(this).fresh()" src="${rootPath}/validate-code"/>
                ...
                <div class="pure-controls">
                    <label for="chbLoginDays" class="pure-checkbox">
                        <input id="chbLoginDays" value="14" name="loginDays" type="checkbox"> 两周直接登录(家庭登录模式)
                        <%--<a href="${root_path}/password/find-by-email">忘记密码</a>--%><br/>
