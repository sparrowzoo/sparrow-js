(() => {
        ...
        122: (e, t, n) => {
            ...
            function r(e, r) {
                for (var a = {}, i = [], c = 0; c < e.length; c++) {
                    var s = e[c], u = r.base ? s[0] + r.base : s[0], l = a[u] || 0, d = "".concat(u, " ").concat(l);
                    a[u] = l + 1;
                    var p = n(d), f = {css: s[1], media: s[2], sourceMap: s[3], supports: s[4], layer: s[5]};
                    if (-1 !== p) t[p].references++, t[p].updater(f); else {
                        var v = o(f, r);
                        r.byIndex = c, t.splice(c, 0, {identifier: d, updater: v, references: 1})
                    }
                    i.push(d)
                }
                return i
    ...
    n.n = e => {
        ...
        var t = n(379), r = n.n(t), o = n(795), a = n.n(o), i = n(569), c = n.n(i), s = n(565), u = n.n(s), l = n(216),
            d = n.n(l), p = n(589), f = n.n(p), v = n(122), m = {};
        m.styleTagTransform = f(), m.setAttributes = u(), m.insert = c().bind(null, "head"), m.domAPI = a(), m.insertStyleElement = d(), r()(v.Z, m), v.Z && v.Z.locals && v.Z.locals, document.getElementById("hello").addEventListener("click", (function () {
            alert(e("zhangsan")), alert(e)
