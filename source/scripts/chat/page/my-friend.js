define([
  ...
  async function removeFriendById() {
    ...
    if (res.code === 200) {
      // 删除好友后,
      removeFriendDom('.my-friend', 'userId');
    }
  }
  ...
  async function removeGroupById() {
    ...
    if (res.code === 200) {
      // 删除群后,
      removeFriendDom('.my-group', 'qunId');
    }
  }
  async function removeFriendDom(selecter, idType) {
