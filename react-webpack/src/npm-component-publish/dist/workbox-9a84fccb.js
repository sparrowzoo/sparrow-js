define(["exports"], (function (t) {
    ...
    const h = {
        ...
        }, u = t => [h.prefix, t, h.suffix].filter((t => t && t.length > 0)).join("-"), l = t => t || u(h.precache),
        f = t => t || u(h.runtime);
    ...
    class L {
        constructor(t, e) {
            this.u = {}, Object.assign(this, e), this.event = e.event, this.l = t, this.p = new v, this.R = [], this.m = [...t.plugins], this.v = new Map;
        ...
        async cachePut(t, e) {
            ...
            if (!c) return !1;
            const {cacheName: a, matchOptions: h} = this.l, u = await self.caches.open(a),
        ...
        async getCacheKey(t, e) {
            ...
            if (!this.u[s]) {
                let n = t;
                for (const t of this.iterateCallbacks("cacheKeyWillBeUsed")) n = U(await t({
                    mode: e,
                    request: n,
                    event: this.event,
                    params: this.params
    ...
    class b {
        ...
        handleAll(t) {
            ...
            const e = t.event, s = "string" == typeof t.request ? new Request(t.request) : t.request,
                n = "params" in t ? t.params : void 0, i = new L(this, {event: e, request: s, params: n}),
                r = this.U(i, s, e);
    ...
    class C extends b {
        constructor(t = {}) {
            t.cacheName = l(t.cacheName), super(t), this.C = !1 !== t.fallbackToNetwork, this.plugins.push(C.copyRedirectedCacheableResponsesPlugin)
        }
        ...
        async N(t, e) {
            ...
            if (!this.C) throw new s("missing-precache-entry", {cacheName: this.cacheName, url: t.url});
            {
                ...
                n = await e.fetch(new Request(t, {integrity: "no-cors" !== t.mode ? r || s : void 0})), s && o && "no-cors" !== t.mode && (this.k(), await e.cachePut(t, n.clone()))
            }
            return n
        }
        ...
        k() {
            let t = null, e = 0;
            for (const [s, n] of this.plugins.entries()) n !== C.copyRedirectedCacheableResponsesPlugin && (n === C.defaultPrecacheCacheabilityPlugin && (t = s), n.cacheWillUpdate && e++);
            0 === e ? this.plugins.push(C.defaultPrecacheCacheabilityPlugin) : e > 1 && null !== t && this.plugins.splice(t, 1)
        }
    }

    C.defaultPrecacheCacheabilityPlugin = {cacheWillUpdate: async ({response: t}) => !t || t.status >= 400 ? null : t}, C.copyRedirectedCacheableResponsesPlugin = {cacheWillUpdate: async ({response: t}) => t.redirected ? await R(t) : t};

    class E {
        constructor({cacheName: t, plugins: e = [], fallbackToNetwork: s = !0} = {}) {
            this.K = new Map, this.T = new Map, this.W = new Map, this.l = new C({
                cacheName: l(t),
        ...
        precache(t) {
            this.addToCacheList(t), this.j || (self.addEventListener("install", this.install), self.addEventListener("activate", this.activate), this.j = !0)
        }
        ...
        addToCacheList(t) {
            ...
            for (const n of t) {
                ...
                const {cacheKey: t, url: i} = d(n), r = "string" != typeof n && n.revision ? "reload" : "default";
                if (this.K.has(i) && this.K.get(i) !== t) throw new s("add-to-cache-list-conflicting-entries", {
                    firstEntry: this.K.get(i),
                    secondEntry: t
                });
                if ("string" != typeof n && n.integrity) {
                    if (this.W.has(t) && this.W.get(t) !== n.integrity) throw new s("add-to-cache-list-conflicting-integrities", {url: i});
        ...
        install(t) {
            return w(t, (async () => {
                ...
                for (const [e, s] of this.K) {
                    const n = this.W.get(s), i = this.T.get(e),
    ...
    function k(t) {
        ...
        !function (t, e, n) {
            ...
            } else if (t instanceof RegExp) o = new r(t, e, n); else if ("function" == typeof t) o = new i(t, e, n); else {
