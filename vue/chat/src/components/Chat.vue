  ...
  <div class="chatPerson">
    ...
    <div class="bottom">
      ...
      <van-field
        ...
        type="textarea"
      />
      <van-button class="send" size="small" type="primary" @click="send()"
        >发送</van-button
      >
    </div>
  </div>
      ...
      Dialog.confirm({
        ...
        .then(() => {
          ...
          const param = {
            ...
            sessionKey: this.session.chatSession.id,
